...
#pontos dos olhos
p_olho_esq = [385, 380, 387, 373, 263, 362]
p_olho_dir = [160, 144, 158, 153, 133, 33]
p_olhos = [385, 380, 387, 373, 263, 362, 160, 144, 158, 153, 133, 33]



def alerta_sonoro():
    pygame.mixer.music.load("caminho/do/seu/som.wav")
    pygame.mixer.music.play()
    sleep(1)

#função para cauculo do EAR
        ...
        try:
            for face_landmarks in saida_facemesh.multi_face_landmarks:
                mp_drawing.draw_landmarks(frame,
                                          face_landmarks, mp_face_mesh.FACEMESH_CONTOURS,
